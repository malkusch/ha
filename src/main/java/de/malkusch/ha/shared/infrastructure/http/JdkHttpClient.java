...
public final class JdkHttpClient implements HttpClient {
    ...
    private static final Header HEADER_FORM = new Header("Content-Type", "application/x-www-form-urlencoded");
    ...
    public HttpResponse post(String url, Field... fields) throws IOException, InterruptedException {
        ...
        return post(url, body, HEADER_FORM);
    }

    @Override
    public HttpResponse post(String url, String body, Header... headers) throws IOException, InterruptedException {
